var map, markerContainer = [], areaContainer = [];

var loadData = (function () {
    var loadData = function (map) {
        var jqxhr = fakeGet("http://www.mocky.io/v2/5900ab591200008913c7b691", function (data) {
            removeMarkers(markerContainer);

            removeAreas(areaContainer);

            areaContainer = _.concat(areaContainer, extractAreas(data));

            markerContainer = _.concat(markerContainer, extractMarkers(data));
